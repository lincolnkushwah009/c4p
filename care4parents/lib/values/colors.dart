...
class AppColors {
  static const Color primaryColor = Color(0xFF2951a3);
  static const Color secondaryColor = Color.fromARGB(255, 246, 247, 255);
  static const Color drawerBackColor = Color(0xFFeaf9f6);

  static const Color dashboardTopBack = Color(0xFF52c3bd);
  static const Color mainText = Color(0xFF204fb2);
  static const Color primaryText = Color(0xFF000000);
  static const Color secodaryText = Color(0xFF707070);
  static const Color tersaryText = Color(0xFF898A8F);
  static const Color backLight = Color(0xFFaab9ce);
  static const Color noDataText = Color(0xFF707070);
  static const Color errorColor = Color(0xFFb71c1c);
  static const Color goldMembershipLight = Color(0xFFffbb2e);
  static const Color goldMembershipDark = Color(0xFFff870b);
  static const Color platinumMembershipLight = Color(0xFF6d7277);
  static const Color platinumMembershipDark = Color(0xFF303133);
  static const Color chart2 = Color(0xFF7bb5ec);
  static const Color chart1 = Color(0xFF434348);
  static const Color lightButton = Color(0xFF52C2BD);
  static const Color tableText = Color(0xFF595c97);
  static const Color level = Color(0xFF51C1BC);
  static const Color levelOn = Color(0xFF0059A5);
  static const Color levelDone = Colors.deepPurple;
  ...
  //grey
  static const Color grey10 = Color(0xFFf3f4f9);
  ...
  static const Color orangeShade7 = Color(0xFFFA9D00);
  ...
  static const Color greenShade2 = Color(0xFF27ae60);
  static const Color greenShade3 = Color(0xFF239C27);

  //lime green
  static const Color lightGreenShade1 = Color(0xFF69C7C6);
  static const Color lightGreenShade2 = Color(0xFF52C2BD);
  ...
  static const Color redShadeDisable = Color(0x54F10A22);
  //Blue
