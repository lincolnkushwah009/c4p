...
class TearmsScreen extends StatefulWidget {
  TearmsScreen({Key key}) : super(key: key);

  @override
  _TearmsScreenState createState() => _TearmsScreenState();
}

class _TearmsScreenState extends State<TearmsScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: CustomAppBar(
            title: StringConst.TEARMS_SCREEN,
            leading: InkWell(
