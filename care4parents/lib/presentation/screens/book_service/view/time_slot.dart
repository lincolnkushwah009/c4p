...
var date;
  TimeSlot({Key key, this.setTime,this.date}) : super(key: key);
...
class _TimeSlotState extends State<TimeSlot> {
  ...
  void _onTimeSelected(time, selectedIndex) {
    ...
    if(currentDate==widget.date){
      print(currentHour.toString()+" sonu "+time);
  ...
  void initState() {
    ...
    Future.delayed(Duration.zero, () {
      final morningStartTime = TimeOfDay(hour: 10, minute: 0);
      ...
      final eveningEndTime = TimeOfDay(hour: 20, minute: 0);
